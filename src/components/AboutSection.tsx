...
import { Sparkles, Utensils, Music, ShieldCheck, Flame, Users, HeartHandshake } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                <dyad-write path="src/components/AboutSection.tsx" description="About section highlighting Ezeji's authentic local Nigerian dining, outdoor/indoor lounge, and cultural vibe">
import React from "react";
import { Sparkles, Utensils, Music, ShieldCheck, Flame, Users, HeartHandshake } from "lucide-react";
import { RESTAURANT_INFO } from "@/data/restaurantData";
